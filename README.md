...
| [docs/specs/wop-sdk-config-spec.md](docs/specs/wop-sdk-config-spec.md) | v0.3-draft | 已评审（K1–K26，2026-09-15） | 各语言 SDK 配置与客户端规范（目标态）：方向性凭证视图（K25/D14/D15）、resetDefault 并发重置（K26）、HTTPS 与 query·fragment 校验（K20）、六语言重复键路径（K21）、重定向矩阵（§7.4.1）、附录 A–F 语言细则 |
